...
@section('content')
  ...
  <div class="container" style="margin-top: 390px;">
    <div class="container">
      <a href="{{ route('register_user') }}"><button type="button" class="btn btn-danger" style="border-radius: 50px; padding: 0.5em 3em; font-family: 'Poppins', sans-serif; font-size: 18px; font-weight: 500; color: white">Register</button></a>
