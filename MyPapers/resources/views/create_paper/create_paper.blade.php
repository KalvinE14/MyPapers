...
@section('content')
    <div class="container" style="background-color: #33415c; border-radius: 45px;width: 500px;margin-top: 40px;">
        <div style="font-weight: 500; font-family: 'Poppins', sans-serif; color: white; text-align: center;margin-bottom: 20px;margin-top: 20px; padding-top: 20px;padding-left: 10px;padding-right: 10px;">
        ...
        <form action="{{ route('create_paper') }}" method="post" enctype="multipart/form-data" style="font-weight: 500; font-family: 'Poppins', sans-serif; color: white;">
            @csrf
            ...
            <div class="form-group" style="width: 100%;margin: auto;text-align: center; margin-bottom: 30px;padding-bottom: 30px;padding-top: 20px;">
