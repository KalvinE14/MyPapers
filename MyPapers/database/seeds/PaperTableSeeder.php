...
class PaperTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('papers')->insert([
            ['paper_id' => 1, 'title' => 'CV for Internship', 'type' => 'Curriculum Vitae', 'requirement' => 'simple design', 'description' => 'include work experience and skills', 'status' => 'Not Accepted', 'file' => 'list of skills.docx', 'preview' => 'previewpaper1.png', 'user_id' => 1, 'expert_id' => null,  'created_at' => '2020-10-30 12:18:30', 'updated_at' => '2020-10-30 14:18:30'],
