...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([
            ['user_id' => 1, 'name' => 'John Doe', 'username' => 'johndoe1', 'email_verified_at' => '2020-10-30 12:18:30', 'password' => Hash::make('johndoe123'), 'address' => 'Avenue Street 21', 'dob' => '23 January 2000', 'gender' => 'Female', 'profile_picture'=> 'profilepicture.png', 'remember_token' => 'remembertoken1', 'created_at' => '2020-10-30 12:17:03', 'updated_at' => '2020-10-31 12:17:03'],
